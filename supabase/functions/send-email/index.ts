...
function getEmailHeader(): string {
  return `
    <div style="text-align: center; margin-bottom: 30px;">
      <img src="${logoUrl}" alt="Ajanta Photography" style="height: 120px; width: auto; object-fit: contain;" />
    </div>
  `;
}
  ...
  return `
    <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #333;">
      <div style="text-align: center; margin-bottom: 15px;">
        <img src="${logoUrl}" alt="Ajanta Photography" style="height: 70px; width: auto; object-fit: contain;" />
      </div>
